...
export class addresslocationController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/addresslocation/:id', this.GpDelete);
this.router.get('/addresslocation/get/search', this.GpSearch);
this.router.put('/addresslocation/get/update', this.GpSearchForUpdate);
this.router.put('/addresslocation', this.GpUpdate);
this.router.get('/addresslocation/:id', this.GpGetNounById);
this.router.get('/addresslocation', this.GpGetAllValues);
this.router.post('/addresslocation', this.GpCreate);
this.router.get('/addresslocation/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.CREATEPHYSCIALADDRESSMANAGERURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.CREATEPHYSCIALADDRESSMANAGERURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.CREATEPHYSCIALADDRESSMANAGERURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.CREATEPHYSCIALADDRESSMANAGERURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
